...
sealed class Screen(val route: String, val icon: ImageVector, val label: String) {
    ...
    object Messages : Screen("messages", Icons.Default.Message, "Сообщения")
    object Chat : Screen("chat/{chatId}", Icons.Default.Message, "Чат") {
...
fun BottomNavigationBar(navController: NavHostController) {
    ...
    NavigationBar {
        mainScreens.forEach { screen ->
            // Для экранов с параметрами, например Chat, сравниваем только начало строки маршрута
